...
export class TutorialDate extends Scene {
  ...
  init(data) {
    // Store data on the scene so other methods can use it
  ...
  create() {
    ...
    this.menuButton = this.add
      ...
      .setAlpha(0);
    this.menuButton.on("pointerdown", () => this.scene.start("HowToScene", {exampleDay: this.exampleDay, exampleMonth: this.exampleMonth, exampleYear: this.exampleYear}));
